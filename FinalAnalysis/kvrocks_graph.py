...
code_analysis = [
    "Yes", "Yes", "No", "No", "Yes", "NA", "No", "Yes", "No", "Yes", "No", "No", 
    "Yes", "Yes", "Yes", "No", "Yes", "Yes", "Yes", "No", "No", "Yes", "Yes", "No", 
    "No", "No", "No", "Yes", "Yes", "Yes", "Yes", "Yes", "Yes", "No", "No", "Yes", 
    "Yes", "Yes", "Yes", "Yes", "No", "No", "NA", "Yes", "Yes", "No", "Yes", "Yes", 
    "Yes", "No", "Yes", "Yes", "Yes", "No", "Yes", "Yes", "Yes", "No", "Yes"
]

# Data from manual analysis (true labels)
manual_analysis = [
    "Yes", "Yes", "Yes", "No", "Yes", "NA", "Yes", "Yes", "Yes", "Yes", "Yes", "No", 
    "Yes", "Yes", "Yes", "No", "Yes", "Yes", "Yes", "Yes", "No", "Yes", "Yes", "No", 
    "No", "Yes", "No", "Yes", "Yes", "Yes", "Yes", "Yes", "Yes", "Yes", "No", "Yes", 
    "Yes", "Yes", "Yes", "Yes", "Yes", "No", "NA", "Yes", "Yes", "Yes", "Yes", "Yes", 
...
plt.savefig('kvrocks_graph_result.png', bbox_inches='tight')
